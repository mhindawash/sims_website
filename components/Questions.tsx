...
function Questions({ question, answer }: Props) {
  return (
    <div className="group relative flex cursor-pointer py-4">
      ...
      <div className="absolute opacity-0 group-hover:opacity-100 transition duration-300 ease-in-out group-hover:bg-white z-0 group-hover:w-h-full text-black group-hover:fill ">
